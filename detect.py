...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='weights/yolov5s6_pose_640.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--kpt-label', default=True, help='use keypoint labels') # action='store_true'
